...
class InfoUpdateClientInformationDto {
  @IsString()
  @ApiProperty({
...
export class InfoUpdateClientDto {
  @IsUUID()
  @IsOptional()
  @ApiProperty({
  ...
  @Type(() => InfoUpdateClientInformationDto)
  clientInformation: InfoUpdateClientInformationDto;
}
