...
class InfoCreateUserPersonalInformationDto {
  @IsEmail()
  @ApiProperty({
...
export class InfoCreateUserDto {
  @IsUUID()
  @IsOptional()
  @ApiProperty({
    description: 'User id',
  ...
  @Type(() => InfoCreateUserPersonalInformationDto)
  personalInformation: InfoCreateUserPersonalInformationDto;
