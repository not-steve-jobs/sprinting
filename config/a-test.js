module.exports = function () {
  return {
    ...
    mailTemplates: [
      ...
      {
        name: 'staffingRequestUpdates',
        id: 'd-0b262d72378b41a3b9b6651f2f6c8437',
      },
      {
      ...
      {
        name: 'newInvoice',
        id: 'd-2edf371152024e4d8d333c4b14733377',
      },
      {
      ...
      },
      {
        ...
        id: 'd-aec0010f96c7481f94b921e1cde20ef0',
      },
      {
        name: 'caseClosed',
    ...
    elasticApm: {
      enabled: process.env.ELASTIC_APM_IS_ENABLED === 'true' || true,
