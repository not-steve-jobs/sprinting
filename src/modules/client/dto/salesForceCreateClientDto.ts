...
class SalesForceCreateClientInformationDto {
  @IsString()
  @ApiProperty({
...
export class SalesForceCreateClientDto {
  @IsUUID()
  @IsOptional()
  @ApiProperty({
  ...
  @Type(() => SalesForceCreateClientInformationDto)
  clientInformation: SalesForceCreateClientInformationDto;
}
