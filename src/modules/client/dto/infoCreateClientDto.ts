...
class InfoCreateClientInformationDto {
  @IsString()
  @ApiProperty({
...
export class InfoCreateClientDto {
  @IsUUID()
  @IsOptional()
  @ApiProperty({
  ...
  @Type(() => InfoCreateClientInformationDto)
  clientInformation: InfoCreateClientInformationDto;
}
