...
/**
 * Feature to control the elements on the Invoices listing page
 *
 * @params {FeatureConfigKey[]} webKeys - Control the columns in the table which is visible on desktop view
 * @params {FeatureConfigKey[]} cardKeys - Control the cards with the details for the Invoices which are visible on mobile view
 * @params {FeatureConfigFilter[]} availableFilters: - Control the filters and their properties
 */
export type InvoicesFeatureConfiguration = ListingPageFeatureConfiguration;
